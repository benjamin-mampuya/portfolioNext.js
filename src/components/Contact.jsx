...
const Contact = () => {
    ...
    return (
        <section id="contact" className="pt-12 pb-4 md:pt-16 md:pb-6 bg-background relative border-b border-borderDark z-[5] transition-colors duration-300 scroll-mt-24">
